...
/* Standard interface: Praktika_Stop, ver. 1.0,
 ...
 extern const MIDL_STUBLESS_PROXY_INFO Praktika_Stop_ProxyInfo;
...
static const RPC_CLIENT_INTERFACE Praktika_Stop___RpcClientInterface =
    {
    ...
    0,
    &Praktika_Stop_ProxyInfo,
    0x02000000
    };
RPC_IF_HANDLE Praktika_Stop_v1_0_c_ifspec = (RPC_IF_HANDLE)& Praktika_Stop___RpcClientInterface;
#ifdef __cplusplus
namespace {
#endif
...
static RPC_BINDING_HANDLE Praktika_Stop__MIDL_AutoBindHandle;
    ...
    /* [in] */ handle_t IDL_handle)
{
    ...
    NdrClientCall3(
                  ( PMIDL_STUBLESS_PROXY_INFO  )&Praktika_Stop_ProxyInfo,
                  0,
                  0,
                  IDL_handle);
...
static const MIDL_STUB_DESC Praktika_Stop_StubDesc = 
    {
    (void *)& Praktika_Stop___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &Praktika_Stop__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& Praktika_Stop_ProxyInfo,   /* proxy/server info */
    0
    };
#ifdef __cplusplus
}
...
static const MIDL_STUBLESS_PROXY_INFO Praktika_Stop_ProxyInfo =
    {
